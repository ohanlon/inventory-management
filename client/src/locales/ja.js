export default {
  ...
  restocking: {
    title: '補充',
    description: '予算を設定し、需要予測に基づいて品目を補充',
    budgetLabel: '利用可能な予算',
    totalCost: '合計コスト',
    remainingBudget: '残り予算',
    placeOrder: '注文する',
    placingOrder: '注文中...',
    successMessage: '注文{orderNumber}を送信しました。予定配達日：{expectedDelivery}',
    errorMessage: '注文の送信に失敗しました：{error}',
    noCandidates: '補充の推奨品目はありません',
    included: '含む',
    excluded: '除外',
    table: {
      sku: 'SKU',
