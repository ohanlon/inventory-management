export default {
  ...
  restocking: {
    ...
    successMessage: 'Order {orderNumber} submitted. Expected delivery: {expectedDelivery}',
    errorMessage: 'Failed to submit order: {error}',
    noCandidates: 'No restocking recommendations available',
    included: 'Included',
    excluded: 'Excluded',
    table: {
      sku: 'SKU',
