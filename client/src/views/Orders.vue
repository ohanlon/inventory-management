          ...
          <table class="orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-date">{{ formatDate(order.expected_delivery) }}</td>
                <td class="col-value"><strong>{{ currencySymbol }}{{ order.total_value.toLocaleString() }}</strong></td>
                <td class="col-lead-time">{{ order.lead_time_days != null ? order.lead_time_days : '—' }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default {
  ...
  setup() {
    ...
    // Submitted orders are independent of the page's status filter, so they're
    // loaded once on mount and not wired into the filters watch above.
